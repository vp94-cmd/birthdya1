...
// Wrapping in try/catch ensures that if the Audio API is unavailable (some
// headless/SSR environments, or certain mobile browsers in restricted mode) the
// rest of the app still loads cleanly instead of crashing at module evaluation.
// ─────────────────────────────────────────────────────────────────────────────
...
try {
  ...
  // Minimal duck-typed fallback so the rest of the code never has to null-check
  _audio = {
