...
// missing credentials or a Supabase module error), the exception propagates
...
// import chain (App → BrowserRouter → ErrorBoundary → pages → Admin → globalStateManager → realtimeSync → supabaseClient)
import('./App.tsx')
  .then(({ default: App }) => {
    root.render(
      <StrictMode>
